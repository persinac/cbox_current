          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul id="main_nav" class="nav navbar-nav">
                ...
                <li id="competitors"><a href="user_edit_profile.php">My Profile</a></li>
...
<script>
	...
	$("#box_selector_div").on("change", "#box_select", function() {
		
		 $( "#box_select option:selected" ).each(function() 
		{
...
function getBoxes() {
	$.ajax({
		type: "GET",
		url: "/CRUD/profiles/getBoxes.php",
		dataType: "html",
		success: function(response) { 
			console.log(response);
			$("#box_selector_div").html(response);
		}
	});
}

function getMembers(box_id) {
	$.ajax({
		type: "POST",
		url: "/CRUD/profiles/getMembers.php",
		data: {"box_id":box_id},
		dataType: "html",
		success: function(response) { 
			console.log(response);
