...
$query_registerNewBox = "insert into box values ('{$t_box_id}', '{$t_boxName}', '{$t_streetAddress}', '{$t_city}', '{$t_state}', '{$t_zipCode}', '{$t_country}', '{$t_phoneNumber}', '{$t_firstname}', '{$t_lastname}', '{$t_email}')";
