...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "User_Home_Page.html";
  ...
  $LoginRS__query=sprintf("SELECT username, password, admin FROM login WHERE username=%s AND password=%s",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text"), GetSQLValueString($admin, "text")); 
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" name="login" class="form-signin" role="form">
